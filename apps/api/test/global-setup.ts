 ...
 * `prisma migrate deploy` errors on an empty migrations directory, so this is a
 * no-op until there is something to apply. */
export default function setup(): void {
  // The unpooled URL, deliberately: `prisma migrate` through pgBouncer hangs
  // with no error and no timeout, wedging this step forever.
