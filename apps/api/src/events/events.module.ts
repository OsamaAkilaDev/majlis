...
// Clubs does not import events, so there is no cycle.
@Module({
  ...
  // AttendanceModule advances an event before every check-in and correction,
  // so nobody scans against a status the clock has moved past.
